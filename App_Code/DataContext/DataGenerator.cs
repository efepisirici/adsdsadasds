...
namespace DataContext {
    public class DataGenerator {
        ...
        private List<Products> CreateProducts() {
            ...
            result.Add(new Products() {
                Id = 6, Name = "Kutu Buyuk", Description = "Rulman paketleme malzemesi (karton)",
